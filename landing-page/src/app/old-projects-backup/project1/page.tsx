// Project 1 Detail Page Template
'use client';
  ...
  return (
    <div className="bg-background text-foreground min-h-screen flex flex-col items-center font-sans px-4 pb-20">
      ...
      <section className="w-full max-w-3xl flex flex-col items-center text-center py-16 gap-4">
        <h1 className="text-4xl font-bold tracking-tight text-primary drop-shadow">Project One</h1>
        <p className="text-lg text-foreground/80 max-w-2xl">A modern productivity app for solo levelers.</p>
      </section>
      {/* Why Section */}
