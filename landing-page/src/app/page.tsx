...
export default function Home() {
  ...
  return (
    <div className="bg-background text-foreground min-h-screen flex flex-col items-center font-sans overflow-x-hidden">
      ...
      {/* Screenshots Section - Horizontal Auto-Scrolling Carousel */}
      <section className="w-full max-w-6xl py-20 flex flex-col items-center gap-8">
        ...
        <div className="w-full">
          <ScrollMenu>
            {screenshotImgs.map((src, i) => (
              <div key={i} className="mx-4 flex-shrink-0 rounded-2xl shadow-card overflow-hidden border border-black/10 dark:border-white/10 bg-white dark:bg-[#18181b]" style={{ width: 315, height: 631 }}>
